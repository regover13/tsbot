...
- **Parallele Segmentverarbeitung**: Alle Audio-Segmente werden gleichzeitig transkribiert (`ThreadPoolExecutor`), danach Offsets berechnet und zusammengeführt → ~N× schneller bei N Segmenten
